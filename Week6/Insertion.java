...
//        try {
//            FileWriter myWriter = new FileWriter("./src/Week6/data8.txt");
//            int n = ThreadLocalRandom.current().nextInt(10, 20);
//
//            for (int i = 0; i < n; ++i) {
//                int x = ThreadLocalRandom.current().nextInt(1, 100);
//                myWriter.write(new Integer(x).toString());
//                myWriter.write(new Integer(16072002).toString());
//                myWriter.write("\n");
//            }
...
//            int[] a = input.readAllInts();
//            Integer[] b = new Integer[a.length];
//            FileWriter myWriter = new FileWriter("./src/Week6/data6.txt");
//
//            for (int i = 0; i < a.length; ++i) {
//                b[i] = a[i];
//            }
...
//                myWriter.write(new Integer(b[i]).toString());
//                myWriter.write("\n");
//            }
//            System.out.println("Successfully wrote to the file.");
//            myWriter.close();
